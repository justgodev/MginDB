...
wget https://mgindb.com/downloads/mgindb-0.1.4-py3-none-any.whl
pip install mgindb-0.1.4-py3-none-any.whl

# Or download the tarball and install manually
wget https://mgindb.com/downloads/mgindb-0.1.4.tar.gz
tar -xzf mgindb-0.1.4.tar.gz
cd mgindb-0.1.4
